...
( function( $ ) {
  ...
  wp.customize( 'x_button_color', function( value ) {
    value.bind( function( newval ) {
      $( '.x-btn' ).css( 'color', newval );
      $( '.button' ).css( 'color', newval );
      $( '[type="submit"]' ).css( 'color', newval );
    } );
  } );

  wp.customize( 'x_button_background_color', function( value ) {
    value.bind( function( newval ) {
      $( '.x-btn' ).css( 'background-color', newval );
      $( '.button' ).css( 'background-color', newval );
      $( '[type="submit"]' ).css( 'background-color', newval );
    } );
  } );

  wp.customize( 'x_button_border_color', function( value ) {
    value.bind( function( newval ) {
      $( '.x-btn' ).css( 'border-color', newval );
      $( '.button' ).css( 'border-color', newval );
      $( '[type="submit"]' ).css( 'border-color', newval );
    } );
  } );

  wp.customize( 'x_button_bottom_color', function( value ) {
    value.bind( function( newval ) {
      $( '.x-btn' ).css( { 'box-shadow' : '0 0.25em 0 0 ' + newval + ', 0 4px 9px rgba(0, 0, 0, 0.75)', '-webkit-box-shadow' : '0 0.25em 0 0 ' + newval + ', 0 4px 9px rgba(0, 0, 0, 0.75)' } );
      $( '.button' ).css( { 'box-shadow' : '0 0.25em 0 0 ' + newval + ', 0 4px 9px rgba(0, 0, 0, 0.75)', '-webkit-box-shadow' : '0 0.25em 0 0 ' + newval + ', 0 4px 9px rgba(0, 0, 0, 0.75)' } );
      $( '[type="submit"]' ).css( { 'box-shadow' : '0 0.25em 0 0 ' + newval + ', 0 4px 9px rgba(0, 0, 0, 0.75)', '-webkit-box-shadow' : '0 0.25em 0 0 ' + newval + ', 0 4px 9px rgba(0, 0, 0, 0.75)' } );
    } );
  } );
