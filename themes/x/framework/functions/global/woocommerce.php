...
// =============================================================================
// FUNCTIONS/GLOBAL/WOOCOMMERCE.PHP
// -----------------------------------------------------------------------------
// Sets up the theme for WooCommerce compatibility.
// =============================================================================
...
function x_woocommerce_shop_columns() {
  return get_theme_mod( 'x_woocommerce_shop_columns' );
}
...
function x_woocommerce_shop_posts_per_page() {
  return get_theme_mod( 'x_woocommerce_shop_count' );
}
...
function x_woocommerce_output_related_products() {
  ...
  $count   = get_theme_mod( 'x_woocommerce_product_related_count' );
  $columns = get_theme_mod( 'x_woocommerce_product_related_columns' );
...
function x_woocommerce_output_upsells() {
  ...
  $count   = get_theme_mod( 'x_woocommerce_product_upsell_count' );
  $columns = get_theme_mod( 'x_woocommerce_product_upsell_columns' );
...
function x_woocommerce_add_remove_product_tabs( $tabs ) {
  ...
  $tab_description     = get_theme_mod( 'x_woocommerce_product_tab_description_enable' );
  $tab_additional_info = get_theme_mod( 'x_woocommerce_product_tab_additional_info_enable' );
  $tab_reviews         = get_theme_mod( 'x_woocommerce_product_tab_reviews_enable' );

  if ( $tab_description == 0 ) {
    unset( $tabs['description'] );
  }

  if ( $tab_additional_info == 0 ) {
