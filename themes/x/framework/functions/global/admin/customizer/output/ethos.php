...
$x_ethos_sizing_site_max_width            = get_theme_mod( 'x_ethos_sizing_site_max_width' );
$x_ethos_sizing_site_width                = get_theme_mod( 'x_ethos_sizing_site_width' );
$x_ethos_sizing_content_width             = get_theme_mod( 'x_ethos_sizing_content_width' );
$x_ethos_bg_color                         = get_theme_mod( 'x_ethos_bg_color' );
$x_ethos_bg_image_pattern                 = get_theme_mod( 'x_ethos_bg_image_pattern' );
$x_ethos_navbar_desktop_link_side_padding = get_theme_mod( 'x_ethos_navbar_desktop_link_side_padding' );
$x_ethos_topbar_background                = get_theme_mod( 'x_ethos_topbar_background' );
$x_ethos_navbar_background                = get_theme_mod( 'x_ethos_navbar_background' );
$x_ethos_sidebar_widget_headings_color    = get_theme_mod( 'x_ethos_sidebar_widget_headings_color' );
$x_ethos_sidebar_color                    = get_theme_mod( 'x_ethos_sidebar_color' );
$x_ethos_post_slider_blog_height          = get_theme_mod( 'x_ethos_post_slider_blog_height' );
$x_ethos_post_slider_archive_height       = get_theme_mod( 'x_ethos_post_slider_archive_height' );
...
<?php if ( get_theme_mod( 'x_ethos_layout_site' ) == 'boxed' ) : ?>
...
.x-navbar .x-nav > li > a,
.x-navbar .x-navbar-inner .x-nav-collapse .x-nav > li.sfHover > a,
...
.x-navbar .x-navbar-inner .x-nav-collapse .x-nav > li.sfHover.current-menu-item > a,
  ...
  if ( $item->type == 'taxonomy' && $item->menu_item_parent == 0 ) {
    ...
    <?php if ( $x_navbar_positioning == 'static-top' || $x_navbar_positioning == 'fixed-top' ) : ?>
      ...
      .x-navbar .x-nav > li.tax-item-<?php echo $t_id; ?>.sfHover > a {
        -webkit-box-shadow: 0 <?php echo $x_ethos_navbar_outer_border_width; ?>px 0 0 <?php echo $accent; ?>;
    ...
    <?php elseif ( $x_navbar_positioning == 'fixed-left' ) : ?>
      ...
      .x-navbar .x-nav > li.tax-item-<?php echo $t_id; ?> > a:hover,
      .x-navbar .x-nav > li.tax-item-<?php echo $t_id; ?>.sfHover > a {
        -webkit-box-shadow: <?php echo $x_ethos_navbar_outer_border_width; ?>px 0 0 0 <?php echo $accent; ?>;
...
<?php if ( $x_navbar_positioning == 'static-top' || $x_navbar_positioning == 'fixed-top' ) : ?>
  ...
  .x-navbar .x-nav > li > a:hover,
  .x-navbar .x-nav > li.sfHover > a {
    -webkit-box-shadow: 0 <?php echo $x_ethos_navbar_outer_border_width; ?>px 0 0 <?php echo $x_site_link_color; ?>;
...
<?php if ( $x_navbar_positioning == 'fixed-left' ) : ?>
  ...
  .x-navbar .x-nav > li > a:hover,
  .x-navbar .x-nav > li.sfHover > a {
    -webkit-box-shadow: <?php echo $x_ethos_navbar_outer_border_width; ?>px 0 0 0 <?php echo $x_site_link_color; ?>;
...
@media (max-width: 979px) {
  ...
  <?php if ( $x_navbar_positioning == 'fixed-left' || $x_navbar_positioning == 'fixed-right' ) : ?>
    ...
    .x-navbar .x-container-fluid.width {
      width: <?php echo $x_ethos_sizing_site_width . '%'; ?>;
    }
