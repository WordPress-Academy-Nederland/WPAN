...
$x_integrity_light_bg_image_pattern = get_theme_mod( 'x_integrity_light_bg_image_pattern' );
$x_integrity_dark_bg_color          = get_theme_mod( 'x_integrity_dark_bg_color' );
$x_integrity_dark_bg_image_pattern  = get_theme_mod( 'x_integrity_dark_bg_image_pattern' );
