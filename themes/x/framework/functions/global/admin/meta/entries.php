  ...
  $meta_box = array(
    ...
    'fields'      => array(
      ...
      array(
        ...
        'desc'    => __( 'Select the layout you would like to display for your portfolio. The "Keep Sidebar" option allows you to keep your sidebar if you have already selected "Content Left, Sidebar Right" or "Sidebar Left, Content Right" for your "Content Layout" in the Customizer.', '__x__' ),
        'id'      => '_x_portfolio_layout',
        'type'    => 'radio-portfolio-layout',
        'std'     => 'full-width',
        'options' => array( 'sidebar' => 'Keep Sidebar', 'full-width' => 'Fullwidth' )
      ),
      array(
