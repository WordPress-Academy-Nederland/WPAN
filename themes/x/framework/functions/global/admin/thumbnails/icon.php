...
if ( ! function_exists( 'x_icon_post_thumbnail_width' ) ) :
  function x_icon_post_thumbnail_width() {
    ...
    $a = get_theme_mod( 'x_icon_layout_site' );
    $b = get_theme_mod( 'x_icon_layout_content' );
    $c = get_theme_mod( 'x_icon_sizing_site_width' );
    $d = get_theme_mod( 'x_icon_sizing_site_max_width' );
...
if ( ! function_exists( 'x_icon_post_thumbnail_width_full' ) ) :
  function x_icon_post_thumbnail_width_full() {
    ...
    $a = get_theme_mod( 'x_icon_layout_site' );
    $b = get_theme_mod( 'x_icon_sizing_site_width' );
    $c = get_theme_mod( 'x_icon_sizing_site_max_width' );
