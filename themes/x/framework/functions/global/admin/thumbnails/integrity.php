...
if ( ! function_exists( 'x_integrity_post_thumbnail_width' ) ) :
  function x_integrity_post_thumbnail_width() {
    ...
    $a = get_theme_mod( 'x_integrity_layout_site' );
    $b = get_theme_mod( 'x_integrity_layout_content' );
    $c = get_theme_mod( 'x_integrity_sizing_site_width' );
    $d = get_theme_mod( 'x_integrity_sizing_site_max_width' );
    $e = get_theme_mod( 'x_integrity_sizing_content_width' );
...
if ( ! function_exists( 'x_integrity_post_thumbnail_width_full' ) ) :
  function x_integrity_post_thumbnail_width_full() {
    ...
    $a = get_theme_mod( 'x_integrity_layout_site' );
    $b = get_theme_mod( 'x_integrity_sizing_site_width' );
    $c = get_theme_mod( 'x_integrity_sizing_site_max_width' );
