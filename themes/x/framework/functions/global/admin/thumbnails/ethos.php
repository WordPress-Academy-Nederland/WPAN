...
if ( ! function_exists( 'x_ethos_post_thumbnail_width' ) ) :
  function x_ethos_post_thumbnail_width() {
    ...
    $a = get_theme_mod( 'x_ethos_layout_site' );
    $b = get_theme_mod( 'x_ethos_layout_content' );
    $c = get_theme_mod( 'x_ethos_sizing_site_width' );
    $d = get_theme_mod( 'x_ethos_sizing_site_max_width' );
    $e = get_theme_mod( 'x_ethos_sizing_content_width' );
