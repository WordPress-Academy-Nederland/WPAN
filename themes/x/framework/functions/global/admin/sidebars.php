...
function ups_sidebar_do_meta_box( $post, $metabox ) {
  ...
  <div class="x-sidebar-options">
    <table class="form-table">
      ...
      <?php endforeach; ?>
      <tr>
        <th scope="row"><label for="ups_sidebars[sidebar-id][<?php echo esc_attr( $sidebar_id ); ?>]">Sidebar ID</label></th>
        <td><input id="ups_sidebars[sidebar-id][<?php echo esc_attr( $sidebar_id ); ?>]" class="regular-text" type="text" name="ups_sidebars[sidebar-id][<?php echo esc_attr( $sidebar_id ); ?>]" value="<?php echo $sidebar_id; ?>" readonly></td>
      </tr>
    </table>
  </div>
...
function ups_sidebars_validate( $input ) {
  if ( isset( $input['add_sidebar'] ) ) {
    ...
    if ( ! empty( $input['add_sidebar'] ) ) {
      ...
      $sidebars['ups-sidebar-' . sanitize_title_with_dashes( $input['add_sidebar'] )] = array(
